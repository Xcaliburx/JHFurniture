...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h2 class="text-center fw-bold mt-4" style="color: #b86ebb">{{ __('Login') }}</h1>

            <form class="mt-4 ms-5" method="POST" action="{{ route('login') }}">
                @csrf

                <div class="row mb-3">
                    <label for="email" class="col-md-4 col-form-label fw-bold">{{ __('Email') }}</label>
